window.AASHUTOSH_PROFILE = {
  ...
  scholarProfile: "https://scholar.google.com/citations?user=e58wgC0AAAAJ&hl=en",
  research: {
    ieeeReferencedPaper: true,
    note: "One of his papers is referenced in IEEE."
  },
  strengths: [
    "Highly skilled at learning and adapting to new things and environments",
    "Highly productive in pressured or competitive environments",
  ...
  education: [
    "Leeds Beckett University (The British College), BSc (Hons) Computing, First Class Honors (2015-2019), Kathmandu"
  ],
  experience: [
  ...
  projects: [
    "Mobile Wallet apps: QPay, PrabhuPay, SCT, MyPay (2018-2022)",
...
window.AASHUTOSH_PROFILE_KB = [
  ...
  "He is highly productive even in pressured or competitive environments.",
  ...
  "Architecture experience includes MVC, MVVM, VIPER, CLEAN, MVP, and BLoC.",
  "Additional strengths include networking, async programming, memory/performance optimization, CI/CD, Git, testing, UI/UX, project management, analytics, leadership, and RnD.",
